...
/// allonbiz luxury color palette.
/// Soft lavender-blue anchors navigation/discovery, bright gold and pink drive premium CTAs,
/// and cool ink/pearl neutrals keep the UI calm and high-end.
class AppColors {
  AppColors._();
