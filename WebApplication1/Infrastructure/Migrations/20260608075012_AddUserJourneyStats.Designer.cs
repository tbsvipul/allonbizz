...
namespace routent.AdminAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260608075012_AddUserJourneyStats")]
    partial class AddUserJourneyStats
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("routent.AdminAPI.Models.Entities.Shop", b =>
                {
                    ...
                    b.ToTable("Shops", t =>
                        {
                            t.HasCheckConstraint("CK_Shops_VerifyStatus", "\"VerifyStatus\" IN ('Pending', 'Verified', 'Rejected')");
                        });
                });
