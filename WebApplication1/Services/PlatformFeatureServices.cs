...
public class PlatformFeatureService : IReviewService, ILoyaltyService, IAdminPanelService, IRuleService, IPlacesService
{
    ...
    public async Task<PagedResponse<ReviewDto>> GetReviewsAsync(Guid? shopId, Guid? offerId, PaginationParams paging, bool publishedOnly = false)
    {
    ...
    public async Task ReplyToReviewAsync(Guid reviewId, ReviewReplyDto dto)
    {
    ...
    public async Task<LoyaltyProgramDto> GetLoyaltyProgramAsync(Guid shopId) 
    {
        _ = await _db.Shops.AsNoTracking().FirstOrDefaultAsync(shop => shop.ShopId == shopId)
    ...
    public async Task<LoyaltyProgramDto> ManageLoyaltyProgramAsync(UpdateLoyaltyProgramDto dto)
    {
        _ = await _db.Shops.AsNoTracking().FirstOrDefaultAsync(shop => shop.ShopId == dto.ShopId)
        ...
        await _db.SaveChangesAsync();
        return await GetLoyaltyProgramAsync(dto.ShopId);
    }
