...
public interface IUserProfileService
{
    ...
    Task<UserHomeDto> GetHomeDataAsync(double? lat, double? lng);
}
...
{
    Task<List<OfferSummaryDto>> GetNearbyOffersAsync(double lat, double lng);
...
{
    Task<List<object>> GetFavouritesAsync(Guid userId);
