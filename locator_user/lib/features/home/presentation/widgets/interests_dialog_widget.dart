        ...
        child: Column(
          ...
          children: [
            ...
            ref
                ...
                .when(
                  data: (tags) {
                    final allChips = [...tags, ..._customTags];
                    // Split tags into 3 rows
                    final rowCount = (allChips.length / 3).ceil();
                    final rows = [
                      allChips.take(rowCount).toList(),
                      allChips.skip(rowCount).take(rowCount).toList(),
                      allChips.skip(rowCount * 2).toList(),
                    ];

                    return SizedBox(
                      height: 160, // Adjusted height for 3 rows
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: rows.map((rowTags) {
                            if (rowTags.isEmpty) return const SizedBox.shrink();
                            return Padding(
